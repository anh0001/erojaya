...
namespace soccervision
{
	...
	class FrameGrabber
	{
		public:
			...
			//! Classified data
			/*! This buffer contains the classified data after each pixel was assigned to its corresponding class. */
		...
		/**
       * Constructor.
       * The constructor will initialize all the necessary variables
       */
		FrameGrabber(){
			imagecounter = 0;

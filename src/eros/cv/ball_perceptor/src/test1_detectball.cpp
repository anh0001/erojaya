...
/** Global variables */
String cascade_name = ros::package::getPath("ball_perceptor") + "/ball_cascade.xml";
...
{
	//ros::init(argc, argv, "DetectBall");
	//ros::NodeHandle nopVisonNode;

	string dirname = ros::package::getPath("ball_perceptor") + "/test_images";
	cout << "EROS TEAM - ball detection with LBP" << endl;
	cout << endl;	
/*
	if (argc == 2) {

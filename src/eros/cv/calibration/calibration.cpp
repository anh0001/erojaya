...
#include <display_image/imagewidget.h>
...
void Calibration::setupDockWidgets()
{
	...
	qRegisterMetaType<calibration::SetCameraParamRequest::Ptr>("calibration::SetCameraParamRequest::Ptr");
	qRegisterMetaType<calibration::EnumerateCameraParamsResponse::Ptr>("calibration::EnumerateCameraParamsResponse::Ptr");
	connect(
		params, SIGNAL(setParam(calibration::SetCameraParamRequest::Ptr)),
		this, SIGNAL(setParam(calibration::SetCameraParamRequest::Ptr))
	);
	connect(
		this, SIGNAL(setParamInfo(calibration::EnumerateCameraParamsResponse::Ptr)),
		params, SLOT(setParamInfo(calibration::EnumerateCameraParamsResponse::Ptr))
	);

...
public:
  ...
  pint   lineBufferCounterToUpdate;
	pbool useKalman;
	...
	localizationC(string prefix) :
			enable(CSTR(enable), true), minLineLen(
					...
					CSTR(coefs/VerLineMinDistanceToUpdate), 0, 0.01, 2, 0.7), lineBufferCounterToUpdate(
					CSTR(lineBufferCounterToUpdate), 5, 1, 60, 30), useKalman(

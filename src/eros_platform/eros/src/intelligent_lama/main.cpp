...
int main(int argc, char **argv){
	...
	while (ros::ok()){
		...
		//initpos=1;
		//GetFieldSampleData(2);
		//-----------------------------------------------------------

		//DEBUG TACTIC
		fprintf(stderr,"%d(%d)X(%3d)Y(%3d)sX(%3d)sY(%3d)m(%2d)aR(%2d)aL(%2d)X(%4d)Y(%4d)%d[%d]\n",step,nBall,dataXB,dataYB,sdtbolax,sdtbolay,motion,arahRobot,arahLihat,dtaXPOS,dtaYPOS,batasGiringY,countertimeout);
		...
		DebugPublish(motion,arahRobot,0,0);

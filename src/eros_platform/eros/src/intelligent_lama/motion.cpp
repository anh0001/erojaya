...
/* **Gerak Dasar Menuju Bola**
   ...
   **GerakHadapBola->GerakCoverBall
   				   ...
   				   ->GerakCoverBallSlow
*/
int GerakHadapBolaBertahan(int sdtX, int sdtY){
	int gerakR = 10;
...
int GerakCuriBall(int sdtX, int sdtY){
	...
	if(sdtY>70){
		...
		else if(sdtX<31  && sdtX>=15) gerakR=50;
		else if(sdtX<15  && sdtX>=1)  gerakR=11;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-15) gerakR=12;
		else if(sdtX<-15 && sdtX>=-31) gerakR=50;
		...
		else if(sdtX<31  && sdtX>=20) gerakR=40;
		else if(sdtX<20  && sdtX>=1)  gerakR=11;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-20) gerakR=12;
		else if(sdtX<-20 && sdtX>=-31) gerakR=40;
		...
		else if(sdtX<24  && sdtX>=1)  gerakR=11;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-24) gerakR=12;
...
int GerakEksekusiDribble(int dataX, int dataY)
{
	...
	{
		if(dataX<53) 		 gerakR = 21;
		else if(dataX < 106) gerakR = 21;
		//else if(dataX < 159) gerakR = 23;
		else if(dataX < 144) gerakR = 21;
		else if(dataX < 212) gerakR = 20;
		else if(dataX < 265) gerakR = 20;
		else if(dataX < 333) gerakR = 22;
		// else if(dataX < 318) gerakR = 24;
		else if(dataX < 371) gerakR = 22;
		else if(dataX < 424) gerakR = 22;
	}
	else if(dataY<240)
	{
		...
		else if(dataX < 131) gerakR = 13;
		else if(dataX < 159) gerakR = 20;
		else if(dataX < 212) gerakR = 20;
		else if(dataX < 265) gerakR = 20;

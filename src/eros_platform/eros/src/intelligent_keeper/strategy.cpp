...
void strategi_serang_WIDE3()
{
	...
	switch(step)
	{
		...
		case 2: TaktikkeBola3(1); break;//
		case 3: step++;break;//Taktikcekjarak3(); fprintf(stderr,"2 ");break;// 
		case 4: step++;break;//PositionGenerator();break;//TaktikcekGW_wide(); lastposrobot=CariSudut(COMPASS_Blue,0); fprintf(stderr,"3 ");break;//
		case 5: step++;break;//TaktikLuruskanGW_wide4(suduteksekusi); fprintf(stderr,"4 ");break;//
		case 6: step++;break;//TaktikNggiring3(); fprintf(stderr,"5 ");break; //
		case 7: step++;break;//TaktikEksekusi4(); fprintf(stderr,"6 "); break; //
		case 8: step=1;counterobseks=0;sudahlihatGW=0;  break;
		case 9: break;
	}
...
void bermain(){
	...
	switch (refree)
	{
		case 0:
		{
			switch(stserang){
				...
				case 4: strategi_serang_WIDE3(); break;
				case 5: strategi_serang_WIDE3(); break;
				case 6: strategi_serang_WIDE3(); break;
				case 7: strategi_serang_WIDE3(); break;
				case 8: strategi_serang_WIDE3(); break;
			default: 	strategi_serang_WIDE3(); break; 
			}
			////fprintf(stderr,"datapc = %d\n",datakompc);
		...
		case 5: //State Ready for Kickoff
		{
			...
			if(nBall == 1){
				...
				/*if(yBall < ((sdtexcute+sdtdefy)/2)){
					...
					KepalaDiamAtas(); KickOff=2; dataTm=dtJob=1;
				}*/
	...
	fprintf(stderr,"dCom= %d | aR = %d | ref=%d | 2nd=%d | sH = %d | dJ = %d | P = %d | nBall = %d\n",dtComm,arahRobot,refree,state2nd,stepH,dtJob, play, nBall);
}
			...
			switch(dtComm)
			{
				case (0 || 1 || 3 || 4): 
					...
					/*switch(stserang){
						...
						case 5: strategi_serang_WIDE5(); break;
						case 6: strategi_serang_WIDE6(); break;
						case 7: strategi_serang_WIDE7(); break;
						case 8: strategi_serang_WIDE8(); break;
					default: 	strategi_serang_WIDE4(); break; 
					}*/
				//break;//BackHome=1; break;
				case 2 : strategi_serang_WIDE3(); break;//strategitunggu(); break;//aktifkansearching(); motion = 0; motionAct(xBall,yBall,motion,0); break;
				case 9 : motionAct(sdtblax,sdtdefy,0,0); break;// motionAct(2050,2050,0,0); Reset();break;
				/*default: 
					switch(stserang){
						case 3: strategi_serang_WIDE3(); break;
						case 4: strategi_serang_WIDE4(); break;

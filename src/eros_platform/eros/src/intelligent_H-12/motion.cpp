...
int GerakHadapBola(int sdtX, int sdtY, int arahrobotskr, int arahhadap){
	...
	if(sdtY>50){
		...
		if(sdtX>30)	gerakR=26;//26 //(sdtX>35)
 		else if(sdtX<-30)	gerakR=25;//25 //(sdtX<-35)
		else if(arahrobotskr >= rotasiarah(arahhadap-1) && arahrobotskr <= rotasiarah(arahhadap+1) && (sdtX > 35)){ //(sdtX>30)
		 	gerakR = 14;
		}
		else if(arahrobotskr >= rotasiarah(arahhadap-1) && arahrobotskr <= rotasiarah(arahhadap+1) && (sdtX < -35)){ //(sdtX<-30)
			gerakR = 13;
			...
			if(arahrobotskr > arahhadap && arahrobotskr <= rotasiarah(arahhadap+10)){
				...
				if(sdtX > 20) 	gerakR = 14;
			}else{
				gerakR = 17; //putar kiri
				if(sdtX < -20) gerakR = 13;//13
			}
		...
		}else if(sdtX>20)	gerakR=14;//26
		else if(sdtX<-20)	gerakR=13;//25
		else gerakR=10;
	}else gerakR=10;
...
int GerakHadapBolaSensitive(int sdtX, int sdtY, int arahrobotskr, int arahhadap){
	...
	else if(sdtY>=0)
	{
		...
		else if(arahrobotskr >= rotasiarah(arahhadap-1) && arahrobotskr <= rotasiarah(arahhadap+1) && (sdtX >= 20)){
		 	gerakR = 14;
		}
		else if(arahrobotskr >= rotasiarah(arahhadap-1) && arahrobotskr <= rotasiarah(arahhadap+1) && (sdtX <= -20)){
			gerakR = 13;
...
int GerakTerobosBola(int sdtX, int sdtY, int arahrobotskr, int arahhadap){
	...
	if(sdtY>45) //Bola Jauh
	{
		...
		gerakR = GerakCuriBall(sdtX,sdtY);
		//fprintf(stderr, "GCB ");
	}else if(sdtY>30 && sdtY<=45)
	{
		gerakR = GerakCuriBallSlow(sdtX,sdtY);
		//fprintf(stderr, "GCBS ");
	}
	else if(sdtY>=0)
	{
...
int GerakCoverBall(int sdtX, int sdtY){
	...
	if(sdtY>70){
		...
		else if(sdtX<-10  && sdtX>=-20) gerakR=41; //
		else if(sdtX<-20 && sdtX>=-35) gerakR=41;
		else if(sdtX<-35 && sdtX>=-39) gerakR=21;
		...
		else if(sdtX<-25 && sdtX>=-30)  gerakR=31;
...
int GerakCuriBall(int sdtX, int sdtY){
	int gerakR;
	if(sdtY>70){
		if(sdtX>=66) gerakR=26;
		else if(sdtX<66  && sdtX>=39) gerakR=50;
		else if(sdtX<39  && sdtX>=31) gerakR=26;
		else if(sdtX<31  && sdtX>=15) gerakR=30;
		else if(sdtX<15  && sdtX>=1)  gerakR=25;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-15) gerakR=26;
		else if(sdtX<-15 && sdtX>=-31) gerakR=30;
		else if(sdtX<-31 && sdtX>=-39) gerakR=25;
		else if(sdtX<-39 && sdtX>=-66) gerakR=50;
		else if(sdtX<-66) gerakR=25;
	} else if(sdtY>60 && sdtY<=70){
		if(sdtX>=55) gerakR=26;
		else if(sdtX<55  && sdtX>=43) gerakR=40;
		else if(sdtX<43  && sdtX>=31) gerakR=26;
		else if(sdtX<31  && sdtX>=20) gerakR=20;
		else if(sdtX<20  && sdtX>=1)  gerakR=25;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-20) gerakR=26;
		else if(sdtX<-20 && sdtX>=-31) gerakR=20;
		else if(sdtX<-31 && sdtX>=-43) gerakR=25;
		else if(sdtX<-43 && sdtX>=-55) gerakR=40;
		else if(sdtX<-55) gerakR=25;
	} else if(sdtY>35 && sdtY<=60){
		if(sdtX>=66) gerakR=12;
		else if(sdtX<66  && sdtX>=41) gerakR=30;
		else if(sdtX<41  && sdtX>=33) gerakR=12;
		else if(sdtX<33  && sdtX>=24) gerakR=20;
		else if(sdtX<24  && sdtX>=1)  gerakR=25;
		/*else if(sdtX<15  && sdtX>=4)  gerakR=22;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=50;
		else if(sdtX<-4  && sdtX>=-15) gerakR=21;*/
		else if(sdtX<1  && sdtX>=-24) gerakR=26;
		else if(sdtX<-15 && sdtX>=-33) gerakR=20;
		else if(sdtX<-33 && sdtX>=-41) gerakR=11;
		else if(sdtX<-41 && sdtX>=-66) gerakR=30;
		else if(sdtX<-66) gerakR=11;
	} else if(sdtY>25 && sdtY<=35){
		if(sdtX>=70) gerakR=26;
		else if(sdtX<70  && sdtX>=44) gerakR=26;
		else if(sdtX<44  && sdtX>=36) gerakR=12;
...
int GerakCoverBallSlow(int sdtX, int sdtY){
	...
	if(sdtY>50 ){
		...
		else if(sdtX<-24 && sdtX>=-34) gerakR=21;
		...
		if(sdtX>=70) gerakR=26;
		else if(sdtX<70  && sdtX>30) gerakR=12;
		else if(sdtX<30  && sdtX>14) gerakR=16;
		else if(sdtX<14  && sdtX>7)  gerakR=14;
		else if(sdtX<=7  && sdtX>=-7) gerakR=10;
		else if(sdtX<-7  && sdtX>=-14) gerakR=13;
		else if(sdtX<-14 && sdtX>=-30) gerakR=15;
		else if(sdtX<-30 && sdtX>=-70) gerakR=11;
		else if(sdtX<-70) gerakR=25;
	}
	return gerakR;
}
...
int GerakCuriBallSlow(int sdtX, int sdtY){
	int gerakR;
	if(sdtY>50 ){
		if(sdtX>=66) gerakR=12;//26;
		else if(sdtX<66  && sdtX>=39) gerakR=22;//12;
		else if(sdtX<39  && sdtX>=31) gerakR=32;//22;
		else if(sdtX<31  && sdtX>=22) gerakR=32;//32;
		else if(sdtX<22  && sdtX>=4)  gerakR=30;//32;
		else if(sdtX<4 	 && sdtX>=-4) gerakR=30;
		else if(sdtX<-4  && sdtX>=-22) gerakR=30;//31;
		else if(sdtX<-22 && sdtX>=-31) gerakR=31;//31;
		else if(sdtX<-31 && sdtX>=-39) gerakR=31;//21;
		else if(sdtX<-39 && sdtX>=-66) gerakR=21;//11;
		else if(sdtX<-66) gerakR=11;//25;
	}
	else if(sdtY>30 && sdtY<=50){
		if(sdtX>=70) gerakR=12;//26;
		else if(sdtX<70  && sdtX>=44) gerakR=22;//12;
		else if(sdtX<44  && sdtX>=36) gerakR=22;//22;
		else if(sdtX<36  && sdtX>=27) gerakR=24;//22;
		else if(sdtX<27  && sdtX>=5)  gerakR=20;//24;
		else if(sdtX<5	 && sdtX>=-5) gerakR=20;
		else if(sdtX<-5  && sdtX>=-27) gerakR=20;//23;
		else if(sdtX<-27 && sdtX>=-36) gerakR=23;//21;
		else if(sdtX<-36 && sdtX>=-44) gerakR=21;//21;
		else if(sdtX<-44 && sdtX>=-70) gerakR=21;//11;
		else if(sdtX<-70) gerakR=11;//25;
	}
	else if(sdtY<=30){
		if(sdtX>=70) gerakR=12;//26;
		else if(sdtX<70  && sdtX>35) gerakR=16;//12;
		else if(sdtX<35  && sdtX>18) gerakR=14;//16;
		else if(sdtX<18  && sdtX>7)  gerakR=10;//14;
		else if(sdtX<=7  && sdtX>=-7) gerakR=10;
		else if(sdtX<-7  && sdtX>=-18) gerakR=10;//13;
		else if(sdtX<-18 && sdtX>=-35) gerakR=13;//15;
		else if(sdtX<-35 && sdtX>=-70) gerakR=15;//11;
		else if(sdtX<-70) gerakR=11;//25;
	}
	return gerakR;
}
...
int GerakEksekusiDribble(int dataX, int dataY)
{
	...
	else if(dataY<120)
	{
		...
		else if(dataX < 144) gerakR = 23;
		else if(dataX < 212) gerakR = 20;
		else if(dataX < 265) gerakR = 20;
		else if(dataX < 333) gerakR = 24;
	...
	else if(dataY<240)
	{
		...
		//else if(dataX < 144) gerakR = 13;
		else if(dataX < 169) gerakR = 20;
		else if(dataX < 212) gerakR = 20;
		else if(dataX < 265) gerakR = 20;
		else if(dataX < 293) gerakR = 20;
		else if(dataX < 318) gerakR = 24;
